...
def ExtractFeaturesForDir(args, dir, prefix):
    command = ['java', '-Xmx4525m', '-XX:MaxNewSize=2500m', '-cp', args.jar, 'JavaExtractor.AndroidApp',
...
if __name__ == '__main__':
    ...
    if args.file is not None:
        command = 'java -cp ' + args.jar + ' JavaExtractor.AndroidApp --max_path_length ' + \
